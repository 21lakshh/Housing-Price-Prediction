...
# Basic Data inspection involves getting statistical insights from data, getting all the data types from the dataset  
...
if __name__ == "__main__":
    ...
    # Load the data
    # df = pd.read_csv('C:/Users/LAKSHYA PALIWAL/Projects/extracted_data/train.csv')
